...
class pam_firewall (
  ...
  firewallchain { [
    ...
    # Changes seen in PAM 2022-03-22-rc1
    'KUBE-EXTERNAL-SERVICES:filter:IPv4',
    'KUBE-EXTERNAL-SERVICES:filter:IPv6',
    'KUBE-NODEPORTS:filter:IPv4',
    'KUBE-NODEPORTS:nat:IPv4',
    'KUBE-NODEPORTS:filter:IPv6',
    'KUBE-NODEPORTS:nat:IPv6',
    'KUBE-PROXY-CANARY:filter:IPv4',
    'KUBE-PROXY-CANARY:mangle:IPv4',
    'KUBE-PROXY-CANARY:nat:IPv4',
    'KUBE-PROXY-CANARY:filter:IPv6',
    'KUBE-PROXY-CANARY:mangle:IPv6',
    'KUBE-PROXY-CANARY:nat:IPv6',
    'KUBE-SERVICES:filter:IPv4',
    'KUBE-SERVICES:filter:IPv6',
  ]:
    ensure => present,
    purge  => false,
  }
